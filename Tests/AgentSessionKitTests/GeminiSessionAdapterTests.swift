...
final class GeminiSessionAdapterTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        home = FileManager.default.temporaryDirectory
            .appendingPathComponent("ASKGeminiSessionTests-\(UUID().uuidString)", isDirectory: true)
    ...
    func testProjectRootMarkerResolvesTheProjectDirectory() throws {
        ...
        XCTAssertEqual(summary.createdAt,
                       ISO8601DateFormatter.kitTest.date(from: "2026-01-01T00:00:00.000Z"))
        XCTAssertEqual(summary.lastActiveAt,
                       ISO8601DateFormatter.kitTest.date(from: "2026-01-01T00:05:00.000Z"))
    }
    ...
    func testTimestampsFallBackToTheMessagesWhenTheHeaderHasNone() throws {
        ...
        let summary = try adapter.extractMetadata(fileURL: url)
        XCTAssertEqual(summary.createdAt,
                       ISO8601DateFormatter.kitTest.date(from: "2026-02-02T10:00:00.000Z"))
        XCTAssertEqual(summary.lastActiveAt,
                       ISO8601DateFormatter.kitTest.date(from: "2026-02-02T11:00:00.000Z"))
    }
