...
///
/// Session logs are read-only inputs everywhere else in this package; this
/// is the single place that removes anything, so it is deliberately
/// paranoid. Before anything is removed:
///
