...
final class GrokSessionAdapterTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        home = FileManager.default.temporaryDirectory
            .appendingPathComponent("ASKGrokSessionTests-\(UUID().uuidString)", isDirectory: true)
    ...
    func testMicrosecondTimestampsAreParsed() throws {
        ...
        XCTAssertEqual(summary.createdAt,
                       ISO8601DateFormatter.kitTest.date(from: "2026-07-20T08:12:28.436Z"))
        XCTAssertEqual(summary.lastActiveAt,
                       ISO8601DateFormatter.kitTest.date(from: "2026-07-20T08:12:38.563Z"))
    }
