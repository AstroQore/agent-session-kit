...
public enum SessionParsing {
    // MARK: - JSON

    public static func json(_ line: Data) -> [String: Any]? {
        guard !line.isEmpty else { return nil }
        return (try? JSONSerialization.jsonObject(with: line)) as? [String: Any]
    }

    public static func jsonObject(at url: URL) -> [String: Any]? {
    ...
    public static func firstDate(_ values: Any?...) -> Date? {
        for value in values {
    ...
    public static func firstString(_ values: Any?...) -> String? {
        for value in values {
    ...
    public static func extractText(_ value: Any?) -> String {
    ...
    public static func firstNonEmptyText(_ values: Any?...) -> String {
        for value in values {
    ...
    public static func isAllToolResults(_ value: Any?) -> Bool {
    ...
    /// `summary` (160) want.
    public static func display(_ text: String?, limit: Int) -> String? {
    ...
    public static let summaryLimit = 160
    ...
    public static func collectFiles(under root: URL, matching predicate: (URL) -> Bool) -> [URL] {
    ...
    public static func creationDate(_ url: URL) -> Date? {
